...
MODULES = [
    ...
    {'slug': 'competencias-comportamentales-tjs', 'tipo': 'competencias_tjs', 'title': 'Análisis de Casos', 'area': 'psicotecnico', 'competencia': 'Análisis de casos y competencias comportamentales', 'tipo_sim': 'tjs', 'description': 'Dilemas de convivencia, comunicación, liderazgo, iniciativa, trabajo en equipo y orientación al logro, calificados por idoneidad graduada.', 'topics': ['Comunicacion asertiva', 'Liderazgo pedagogico', 'Trabajo colaborativo', 'Orientacion al logro']},
